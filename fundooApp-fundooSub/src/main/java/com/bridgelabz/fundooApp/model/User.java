...
public class User 
{
	 ...
	 * @param updateTime
	 */
	public User(String userId, @Email(message = 
			"Email should not be null") String email, String name, 
			String password,String phoneNumber, String address, 
			boolean isVerified, LocalDateTime creationTime,
	...
	public String toString() 
	{
		return "User [userId=" + userId + ", email=" + email 
				...
				+ ", creationTime=" + creationTime + ", updateTime=" 
				+ updateTime + "]";
	}
}
