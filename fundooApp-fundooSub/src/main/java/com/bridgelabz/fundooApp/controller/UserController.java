...
public class UserController 
{
	...
	public ResponseEntity<Response> registerUser(@Valid @RequestBody 
	...
	@PostMapping("/login")
	public ResponseEntity<Response> loginUser(@RequestBody LoginDto 
			loginDto, HttpServletResponse httpServletResponse)
			throws IllegalArgumentException, UnsupportedEncodingException 
	{
		String token = userService.loginUser(loginDto);
		httpServletResponse.setHeader("Authorization", token);
		Response response = new Response(HttpStatus.OK
				.value(), "User logged in successfully", null);
		return new ResponseEntity<Response>(response, HttpStatus.OK);
	}

	@GetMapping("/forget")
	public ResponseEntity<Response> forgotPassword(@RequestParam 
	...
	public ResponseEntity<Response> resetPassword(@RequestParam String 
			token, @RequestBody String password) 
	{
	...
	public ResponseEntity<Response> mailValidation(@PathVariable 
			String token) 
	{
