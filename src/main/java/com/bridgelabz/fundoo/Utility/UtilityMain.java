...
public class UtilityMain 
{
	...
	{
		final String fromEmail = "azamali12345@gmail.com"; // requires valid gmail id
		final String password = "passwordPlz"; // correct password for gmail id
		...
		try 
		{
			...
			msg.setReplyTo(InternetAddress.parse("azamali12345@gmail.com", false));
